...
export default function RoutineDetailScreen() {
  ...
  const startWorkout = () => {
    if (!routine) return;
    // For now, just show an alert since the workout screen doesn't exist yet
    Alert.alert(
      "Workout Feature",
      "The workout feature is coming soon! You'll be able to start workouts from your routines.",
      [{ text: "OK" }]
    );
  };
