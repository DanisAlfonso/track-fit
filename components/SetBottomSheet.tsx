...
const TRAINING_TYPES = [
  ...
  { value: 'light', label: 'Light', description: '13+ reps', color: '#4CAF50', icon: 'flash' },
];
...
export const SetBottomSheet: React.FC<SetBottomSheetProps> = ({
  ...
  const handleInputChange = (field: keyof TouchedFields | 'rest_time' | 'training_type', value: string | number | 'heavy' | 'moderate' | 'light') => {
  ...
  // Render previous performance card if available
